...
def make_exe(dist):
    ...
    #     write_modules_directory_env=None,
        run_eval="import daemon; daemon.main()",
    #     run_module=None,
    #     run_noop=False,
    #     run_repl=True,
    )
    ...
    exe.add_in_memory_python_resources(dist.read_package_root(
        path="./py_lib",
        packages=["constants", "daemon", "fswatcher", "httpserver", "imdb_datasets", "imdbid", "imdbid_db", "load_config", "omdb", "ost", "plex", "subtitle", "util"],
    ))
